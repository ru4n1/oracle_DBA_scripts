...
1.0 Introduction
----------------
This archive contains two versions of the XPLAN utility. XPLAN is a wrapper over DBMS_XPLAN functions that re-formats plan output to include parent operation ID and execution order columns. This makes plan interpretation easier for larger or more complex execution plans.

2. Versions
-----------
There are two versions provided:

2.1. xplan.package.sql
- - - - - - - - - - - -
...
2.2 xplan.display.sql
    xplan.display_cursor.sql
    xplan.display_awr.sql
- - - - - - - - - - - - - - 
